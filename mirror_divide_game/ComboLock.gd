...
var correct_code = [3, 1, 5]  # Change this to your desired combo
...
func unlock_door():
	# Emit a signal or call a function to unlock the door
	print("Door opens!")  # Replace with actual door unlock logic
